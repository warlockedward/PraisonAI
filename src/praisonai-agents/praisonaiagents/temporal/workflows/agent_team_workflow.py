...
with workflow.unsafe.imports_passed_through():
    ...
    from praisonaiagents.temporal.converter import deserialize_task_output
...
class AgentTeamWorkflow:
    ...
    async def run(self, input_data: TeamInput) -> Dict[str, Any]:
        """Execute a team of agents according to the process mode."""
        ...
        if input_data.process_mode == "sequential":
            ...
            raise ValueError(f"Unknown process mode: {input_data.process_mode}")
    ...
    async def _run_hierarchical(self, input_data: TeamInput) -> Dict[str, Any]:
        """Stub for hierarchical execution."""
